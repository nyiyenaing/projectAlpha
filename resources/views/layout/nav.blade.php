        ...
        <!--div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="{{ url('/cart') }}">Cart
                    ...
                    <li><a href="{{ url('order/orderList') }}">Manage Orders</a></li>

                    <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Category<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="{{url('/category/create')}}">Create Category</a></li>
                        <li><a href="{{url('/category/read')}}">Manage Categories</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="dropdown-menu">
                       ...
                       <!-- <li><a href="{{url('/product/show')}}">View products</a></li> -->
                        <li><a href="{{url('/product/manage')}}">Manage Products</a></li>
                    </ul>
                    </li>
                     @endif
